# Introduction
Intuitives is a holistic audio production that focuses on deeply integrated
...
contribute plugins to Intuitives, but they must be integrated into the main
source code repository and thoroughly tested for quality.

# Hardware Support
Intuitives supports any audio and MIDI devices supported by Portaudio and
Portmidi, respectively.

# Platform Support
Intuitives targets any platform that can run Python, PyQt, and has drivers for
