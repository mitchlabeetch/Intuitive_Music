# Arch Linux
This document describes how to build Intuitives DAW for Arch Linux
and it's derivatives like Manjaro and others.

Note that Intuitives DAW is available in [AUR](
  https://aur.archlinux.org/packages/intuitives/
)
...
# Build Procedure
```
git clone --recurse-submodules https://github.com/intuitivesdaw/intuitives.git
cd intuitives
# First time only
