try:
    from int_vendor.pymarshal.json import *
except ImportError:
    from pymarshal.json import *

from intlib.constants import HOME, MAJOR_VERSION
...
def setup_globals():
    ...
    if THEME_FILE:
        # The Windows install prefix changes everytime Intuitives is launched,
