...
from intlib.models import intuitives as sg_project
from intlib.models import theme
from intlib.ipc import *
from intlib.lib import util
from intlib.lib.process import run_process
from intlib.lib.util import *
from intlib.lib.translate import _
from intlib.lib.appimage import *
from intlib.log import LOG
from intlib.lib.pidfile import create_pidfile
from intlib import constants
from intlib.math import clip_value, db_to_lin
from intui import widgets
from intui.daw import entrypoint as daw
from intui.daw.item_editor.audio._shared import (
    remove_path_from_painter_path_cache,
)
from intui.ipc.socket import SocketIPCServer, SocketIPCTransport
from intui.plugins import SgPluginUiDict
from intui.transport import TransportWidget
from intlib.lib import engine
from intlib.lib.engine import *
...
from intui.widgets.file_browser import open_bookmarks
import gc
import os
import subprocess
import sys
...
def handle_engine_error(exit_code):
    ...
    if exit_code == 1003:
        msg = (
            ...
            "are using the device and try restarting Intuitives"
        )
    else:
        msg = (
            f"The audio engine stopped with exit code {exit_code}, "
             "please try restarting Intuitives"
        )
...
class SgMainWindow(QWidget):
    ...
    def setup(self, scaler):
        ...
        self.quit_action.setToolTip('Close Intuitives DAW')
        ...
        self.open_theme_action.setToolTip(
            'Open a new sgtheme file to change the appearance of Intuitives.  '
        ...
        self.samplepack_action = self.menu_help.addAction(
            _("Download the official Intuitives DAW sample pack"),
        )
        ...
        if all(x in os.environ for x in ('APPIMAGE', 'APPDIR')):
            ...
            self.appimage_uninstall_action.setToolTip(
                'Uninstall Intuitives DAW AppImage from the start menu.  '
    ...
    def on_samplepack(self):
        url = QtCore.QUrl(
            "https://github.com/intuitivesdaw/intuitives-sample-pack",
        )
    ...
    def on_use_default_theme(self):
        ...
        QMessageBox.warning(
            MAIN_WINDOW,
            _("Theme Applied..."),
            _("Changed theme.  Please restart Intuitives DAW")
        )
