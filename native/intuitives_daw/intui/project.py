...
from intui import util
from intlib.constants import (
    DEFAULT_PROJECT_DIR,
    IS_PORTABLE_INSTALL,
    MAJOR_VERSION,
)
from intlib.lib import portable
...
class IntuitivesProjectVersionError(Exception):
    """ Raised when the project has been opened in a newer version
        of Intuitives than the version being run
    """
...
def check_project_version(parent, project_file):
    ...
    if (
        ...
        msg = _(
            "Please update to the latest version of Intuitives.  "
        ...
        raise IntuitivesProjectVersionError
