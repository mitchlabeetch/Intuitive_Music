...
from intlib.api.wave_edit import api_project_notes
from intlib.ipc.abstract import AbstractIPC
...
#            QKeySequence.fromString("ALT+C"))
        ...
        self.bookmark_action.setToolTip(
            ...
            'again later, even after closing and reopening Intuitives DAW'
        )
