...
from intui.widgets.control import slider_control
from intlib.lib._ctypes import *
from intlib.hardware.rpi import is_rpi
...
NO_MIDI_DEVICES_MSG = """\
No MIDI devices detected.  If this is not expected, try closing Intuitives DAW,
...
from intlib.lib.translate import _, log_decode
...
#            LOG.error("close_devices called, but devices are not open")
    ...
    def hardware_dialog_factory(
        ...
        f_audio_out_spinbox.setToolTip(
            ...
            'device.  Currently, Intuitives only supports using 2 outputs as '
